...
def main():
    ...
    agent_args.add_argument('--learning_rate', default=2e-5, type=np.float16)
    ...
    agent_args.add_argument('--buffer_size', default=100_000, type=int)
    ...
    env_args.add_argument('--scale_factor', default=4, type=np.float16)
    env_args.add_argument('--meters_per_pixel', default=0.0375, type=np.float16)
    ...
    env_args.add_argument('--step_size', default=0.5, type=np.float16)
    env_args.add_argument('--constant_lin_vel', default=True, action=BooleanOptionalAction)
    env_args.add_argument('--max_lin_vel', default=0.26, type=np.float16)
    env_args.add_argument('--max_ang_vel', default=1.0, type=np.float16)
    env_args.add_argument('--max_lin_acc', default=None, type=np.float16)
    env_args.add_argument('--max_ang_acc', default=None, type=np.float16)
    env_args.add_argument('--action_delay', default=0, type=np.float16)
    env_args.add_argument('--steering_limits_lin_vel', default=True, action=BooleanOptionalAction)
    env_args.add_argument('--mower_radius', default=0.15, type=np.float16)
    env_args.add_argument('--lidar_rays', default=24, type=int)
    env_args.add_argument('--lidar_range', default=3.5, type=np.float16)
    env_args.add_argument('--lidar_fov', default=345, type=np.float16)
    env_args.add_argument('--position_noise', default=0.01, type=np.float16)
    env_args.add_argument('--heading_noise', default=0.05, type=np.float16)
    env_args.add_argument('--lidar_noise', default=0.05, type=np.float16)
    ...
    env_args.add_argument('--eval', default=True, action=BooleanOptionalAction)
    env_args.add_argument('--p_use_known_obstacles', default=0.7, type=np.float16)
    env_args.add_argument('--p_use_unknown_obstacles', default=0.7, type=np.float16)
    env_args.add_argument('--p_use_floor_plans', default=0.7, type=np.float16)
    ...
    env_args.add_argument('--obstacle_radius', default=0.25, type=np.float16)
    ...
    env_args.add_argument('--goal_coverage', default=0.9, type=np.float16)
    env_args.add_argument('--goal_coverage_reward', default=0, type=np.float16)
    env_args.add_argument('--wall_collision_reward', default=-10, type=np.float16)
    env_args.add_argument('--obstacle_collision_reward', default=-10, type=np.float16)
    env_args.add_argument('--newly_visited_reward_scale', default=1, type=np.float16)
    env_args.add_argument('--newly_visited_reward_max', default=2, type=np.float16)
    env_args.add_argument('--overlap_reward_scale', default=0, type=np.float16)
    env_args.add_argument('--overlap_reward_max', default=5, type=np.float16)
    env_args.add_argument('--overlap_reward_always', default=False, action=BooleanOptionalAction)
    env_args.add_argument('--local_tv_reward_scale', default=1, type=np.float16)
    env_args.add_argument('--local_tv_reward_max', default=5, type=np.float16)
    env_args.add_argument('--global_tv_reward_scale', default=0, type=np.float16)
    env_args.add_argument('--global_tv_reward_max', default=5, type=np.float16)
    ...
    env_args.add_argument('--frontier_reward_scale', default=0, type=np.float16)
    env_args.add_argument('--frontier_reward_max', default=5, type=np.float16)
    env_args.add_argument('--turn_reward_scale', default=0, type=np.float16)
    env_args.add_argument('--obstacle_dilation', default=9, type=int)
    env_args.add_argument('--constant_reward', default=-0.1, type=np.float16)
    env_args.add_argument('--constant_reward_always', default=True, action=BooleanOptionalAction)
    env_args.add_argument('--truncation_reward_scale', default=0, type=np.float16)
