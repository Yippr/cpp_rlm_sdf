...
#===========================SDF_reward===========================
        ...
        reward_sdf_zero = - (0.25 * zero_sdf_ratio + 0.25 * delta_zero_sdf_ratio)
        ...
        if 0< coverage_sdf < distance_threshold:
            coverage_reward = self.sdf_reward_scale / (abs(coverage_sdf) + epsilon)
        else:
            coverage_reward = 0

        # 合并奖励
        sdf_reward = obstacle_reward + coverage_reward + reward_sdf_zero
        ...
        reward = reward_area + reward_ovrlp +reward_sdf_zero+ reward_frontier + reward_turn + reward_coll + reward_goal + reward_trunc + reward_const + sdf_reward
    ...
    def _compute_sdf(self, binary_map):
        ...
        #sdf_map = (dist_inside - dist_outside) * self.meters_per_pixel
        sdf_map = (dist_outside - dist_inside) * self.meters_per_pixel
        return sdf_map
